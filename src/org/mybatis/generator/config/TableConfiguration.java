...
public class TableConfiguration extends PropertyHolder {
	...
	public String toString() {
		return "TableConfiguration [insertStatementEnabled=" + insertStatementEnabled
				...
				+ selectByExampleQueryId + ", catalog=" + catalog + ", schema=" + schema + ", tableName=" + tableName
				+ ", domainObjectName=" + domainObjectName + ", alias=" + alias + ", modelType=" + modelType
				+ ", wildcardEscapingEnabled=" + wildcardEscapingEnabled + ", configuredModelType="
				+ configuredModelType + ", delimitIdentifiers=" + delimitIdentifiers + ", columnRenamingRule="
				+ columnRenamingRule + ", isAllColumnDelimitingEnabled=" + isAllColumnDelimitingEnabled + "]";
	}
